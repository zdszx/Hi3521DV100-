...
HI_S32 SAMPLE_VDEC_PIP(HI_VOID)
{
    ...
    stSize.u32Width = _720P_WIDTH;                   //change
    stSize.u32Height = _720P_HEIGHT;
    ...
    *************************************************/
    ...
    Sample_COMM_VPSS_StartCover(1);           //can change region function
    /************************************************
    step5:  start VO
    *************************************************/
    ...
    stVoLayerAttr.stDispRect.u32Width = 1280;
    stVoLayerAttr.stDispRect.u32Height = 720;                        //change
    ...
    *************************************************/
    SAMPLE_COMM_VDEC_ThreadParam(u32VdCnt, &stVdecSend[0], &stVdecChnAttr[0], "stream_chn0.h264");   //change path
...
HI_S32 SAMPLE_VDEC_H264(HI_VOID)
{
    ...
    stSize.u32Width = _720P_WIDTH;           //size change
    stSize.u32Height = _720P_HEIGHT;
    ...
    *************************************************/
    ...
    /************************************************
    step8:  send stream to VDEC
    *************************************************************************vdec file path change below line!*/
    SAMPLE_COMM_VDEC_ThreadParam(u32VdCnt, &stVdecSend[0], &stVdecChnAttr[0], "stream_chn0.h264"); //PATH change
    SAMPLE_COMM_VDEC_StartSendStream(u32VdCnt, &stVdecSend[0], &VdecThread[0]);
